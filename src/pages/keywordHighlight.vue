<template>
  <div class="wrapper">
    <el-input
      placeholder="请输入高亮关键字"
      v-model.trim="query"
      @keypress.enter.native="handleAdd"
    >
      <el-select v-model="mode" slot="prepend" placeholder="请选择">
        <el-option label="简单版" value="simple"></el-option>
        <el-option label="完整版" value="full"></el-option>
      </el-select>
      <el-button type="primary" slot="append" @click="handleAdd"
        >+添加</el-button
      >
    </el-input>
    <div class="tag-wrap">
    ...
    <div
      v-if="mode === 'simple'"
      key="simple"
      v-keyword_simple:[keywords]="content"
      class="content"
    ></div>
    <div
      v-else
      key="full"
      v-keyword_full:[keywords]="content"
      class="content"
    ></div>
  </div>
</template>
